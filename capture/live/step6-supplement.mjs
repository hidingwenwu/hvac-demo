...
const TARGETS = [
  ['/envSensorDevice/routerView', 'ctrl-env'],
  ['/envSensorDeviceMgr/routerView', 'device-env'],
  ['/loadControl/perceptionLinkage/index', 'strategy-env'],
  ['/loadControl/geomancyLinkage/index', 'strategy-wind'],
];
...
await projInput.fill('青岛飞奕'); await page.waitForTimeout(1500);
try { await page.locator('.el-select-dropdown__item:visible', { hasText: '青岛飞奕' }).first().click({ timeout: 6000 }); }
